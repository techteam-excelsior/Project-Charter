...
class Page8ViewController: UIViewController, UIScrollViewDelegate, UIGestureRecognizerDelegate {
    ...
    convenience init(_: Int){
        self.init()
        updateArrays()
        customTable = CustomTableView(withTable: myTable, withIndex: 7)
    }
...
extension Page8ViewController: homeDelegate
{
