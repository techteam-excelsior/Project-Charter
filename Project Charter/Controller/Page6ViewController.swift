...
class Page6ViewController: UIViewController, UIScrollViewDelegate, UIGestureRecognizerDelegate {
    ...
    convenience init(_: Int){
        self.init()
        updateArrays()
        customTable = CustomTableView(withTable: myTable, withIndex: 5)
    }
...
extension Page6ViewController: homeDelegate
{
