...
//        resizeScrollView()
    ...
    func updateArrays(){
        keyArray.append("Financial Benefits")
        valArray.append("")
        keyArray.append("Incremental sales")
        valArray.append("")
        keyArray.append("Profitability")
        valArray.append("")
        keyArray.append("Payback period")
        valArray.append("")
        keyArray.append("Annual savings")
        valArray.append("")
